...
import type { XYXYBox, BoundingBox, YOLODetection, YOLOProcessOptions } from "../types";
import {
	clampBoundingBox,
	processYOLOOutput,
	scaleBoundingBox,
...
describe("processYOLOOutput", () => {
	...
	it("rescales model-space coordinates into source image coordinates", () => {
		...
		const options: YOLOProcessOptions = { scaleX: 2, scaleY: 0.5, imageWidth: 640, imageHeight: 240 };

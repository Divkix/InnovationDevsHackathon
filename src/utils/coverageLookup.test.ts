...
import type { PolicyType, CoverageResult, CoverageStatus } from '../types'
import {
  lookupCoverage,
  VALID_POLICY_TYPES,
...
describe('coverageLookup', () => {
  ...
  describe('compareCoverageAcrossPolicies', () => {
    it('returns comparison for all 4 policy types', () => {
      const comparison: Record<PolicyType, CoverageResult> = compareCoverageAcrossPolicies('laptop')
    ...
    it('returns valid CoverageResult for each policy', () => {
      const comparison: Record<PolicyType, CoverageResult> = compareCoverageAcrossPolicies('bicycle')
    ...
    it('handles unknown categories gracefully', () => {
      const comparison: Record<PolicyType, CoverageResult> = compareCoverageAcrossPolicies('unknown')

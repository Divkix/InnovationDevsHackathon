...
import type { PolicySelectorProps, DetectedItem, ManualItem, PolicyType } from '../../types';
...
export function PolicySelector({ 
   ...
   */
  const handlePolicySelect = useCallback((newPolicyType: PolicyType): void => {
   ...
   */
  const handleKeyDown = useCallback((event: React.KeyboardEvent<HTMLButtonElement>, policyTypeValue: PolicyType): void => {

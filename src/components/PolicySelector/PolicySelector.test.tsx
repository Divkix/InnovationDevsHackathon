...
import type { DetectedItem, ManualItem, PolicyType, CoverageResult } from '../../types'
...
describe('PolicySelector', () => {
  ...
  describe('Red Moment - No Insurance Mode', () => {
    ...
    it('displays 100% coverage gap for No Insurance', async () => {
      renderWithProvider(<PolicySelector detectedItems={mockDetectedItems} manualItems={mockManualItems} />)
    ...
    it('shows protected value as $0 for No Insurance', async () => {
      ...
      renderWithProvider(<PolicySelector detectedItems={singleItem} manualItems={mockManualItems} />)
  ...
  describe('Dashboard Arithmetic Invariant', () => {
    it('maintains total = protected + unprotected during policy switches', async () => {
      ...
      renderWithProvider(<PolicySelector detectedItems={mockDetectedItemsThree} manualItems={mockManualItems} />)

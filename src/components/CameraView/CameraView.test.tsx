...
import type { AppContextValue, DetectedItem, Detection } from "../../types";
...
describe("CameraView", () => {
  ...
  // Mock getUserMedia
  const mockGetUserMedia = vi.fn() as Mock<
    (constraints?: MediaStreamConstraints) => Promise<MediaStream>
  >;
  const mockVideoStream = {
    getTracks: vi.fn(() => [{ stop: vi.fn(), kind: "video" } as unknown as MediaStreamTrack]),

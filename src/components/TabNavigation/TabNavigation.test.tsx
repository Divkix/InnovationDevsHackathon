...
describe("TabNavigation", () => {
  ...
  describe("tab switching", () => {
    it('calls onTabChange with "dashboard" when dashboard tab clicked', async () => {
      const onTabChange = vi.fn<(tab: AppTab) => void>();
    ...
    it("does not call onTabChange if onTabChange is undefined", async () => {
      // Pass a mock that does nothing to satisfy type requirements
      render(<TabNavigation activeTab="camera" onTabChange={() => {}} />);
  ...
  describe("custom className", () => {
    it("applies additional className when provided", () => {
      render(
        <TabNavigation activeTab="camera" onTabChange={vi.fn()} className="my-custom-class" />,
      );

...
describe("ConfidenceThresholdSlider", () => {
  ...
  describe("rendering", () => {
    it("renders with default expanded state", () => {
      render(<ConfidenceThresholdSlider value={0.5} onChange={mockOnChange} />);
    ...
    it("displays value as percentage", () => {
      render(<ConfidenceThresholdSlider value={0.75} onChange={mockOnChange} />);
  ...
  describe("collapsible behavior", () => {
    ...
    it("can be initialized in collapsed state", () => {
      render(
        <ConfidenceThresholdSlider value={0.5} onChange={mockOnChange} defaultCollapsed={true} />,
      );
  ...
  describe("different values", () => {
    it.each([
      ...
      const { unmount } = render(
        <ConfidenceThresholdSlider value={value} onChange={mockOnChange} />,
      );
    ...
    it.each([
      ...
      render(
        <ConfidenceThresholdSlider value={value} onChange={mockOnChange} defaultCollapsed={true} />,
      );
  ...
  describe("styling", () => {
    it("applies custom className when provided", () => {
      render(
        <ConfidenceThresholdSlider value={0.5} onChange={mockOnChange} className="custom-class" />,
      );
  ...
  describe("edge cases", () => {
    it("handles value at lower boundary", () => {
      render(<ConfidenceThresholdSlider value={0.1} onChange={mockOnChange} />);
    ...
    it("handles value at upper boundary", () => {
      render(<ConfidenceThresholdSlider value={0.9} onChange={mockOnChange} />);

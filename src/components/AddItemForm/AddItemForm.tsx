...
const MANUAL_CATEGORIES: CategoryConfig[] = [
  {
    ...
    icon: Gem,
    description: "Rings, necklaces, watches, precious metals",
  },
  {
    id: "musical_instruments",
    label: "Musical Instruments",
    icon: Music,
    description: "Guitars, pianos, violins, drums",
  },
  {
    id: "art_collectibles",
    label: "Art & Collectibles",
    icon: Palette,
    description: "Paintings, sculptures, memorabilia",
  },
  {
    id: "cameras",
    label: "Cameras & Equipment",
    icon: Camera,
    description: "DSLRs, lenses, tripods, lighting",
  },
  {
    id: "gaming_equipment",
    label: "Gaming Equipment",
    icon: Gamepad2,
    description: "Consoles, high-end PCs, accessories",
  },
  {
    id: "power_tools",
    label: "Power Tools",
    icon: Wrench,
    description: "Drills, saws, lawn equipment",
  },
  {
    id: "exercise_equipment",
    label: "Exercise Equipment",
    icon: Dumbbell,
    description: "Treadmills, weights, bikes",
  },
  {
    id: "firearms",
    label: "Firearms",
    icon: Target,
    description: "Guns, hunting equipment (requires special coverage)",
  },
  {
    id: "silverware",
    label: "Silverware & China",
    icon: UtensilsCrossed,
    description: "Fine dining sets, heirloom silver",
  },
  {
    id: "furs",
    label: "Furs & Luxury Items",
    icon: Briefcase,
    description: "Fur coats, designer handbags",
  },
...
export function AddItemForm({
  ...
  editItem = null,
  onSave,
}: AddItemFormProps): ReactElement | null {
    ...
    >
      ...
      <div className="relative w-full max-w-lg bg-white rounded-2xl shadow-xl overflow-hidden max-h-[90vh] flex flex-col">
        ...
        <form onSubmit={handleSubmit} className="flex-1 overflow-y-auto p-6 space-y-6">
          ...
          <div>
            ...
            {errors.name && (
              <p id="name-error" className="mt-1 text-sm text-red-600 flex items-center gap-1">
                <span className="inline-block w-4 h-4 rounded-full bg-red-100 text-red-600 text-xs flex items-center justify-center font-bold">
                  !
                </span>
                {errors.name}
              </p>
          ...
          {/* Value Field */}
          <div>
            <label htmlFor="item-value" className="block text-sm font-medium text-gray-700 mb-2">
...
export function ManualItemsList({
  ...
  onRemove,
  onItemClick,
}: ManualItemsListProps): ReactElement | null {

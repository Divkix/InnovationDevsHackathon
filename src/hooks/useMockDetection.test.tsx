...
import { useMockDetection, MOCK_STORAGE_KEY, type UseMockDetectionReturn } from './useMockDetection'
import { getMockDetections, MOCK_LAPTOP, MOCK_CAR, MOCK_BICYCLE } from './mockDetections'
